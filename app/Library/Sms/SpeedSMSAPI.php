...
class SpeedSMSAPI {
	...
	#const SMS_TYPE_BRANDNAME = 4; // sms gui bang brandname Notify
	#const SMS_TYPE_BRANDNAME = 5; // sms gui bang so di dong ca nhan tu app android, download app tai day: https://play.google.com/store/apps/details?id=com.speedsms.gateway
    ...
    public function sendSMS($to, $smsContent, $smsType, $sender) {
        ...
        if (($type == 3 || $type == 4 || $type == 5) && empty($sender))
            return null;
